...
instructions = "Please summarize the dairy entry below in outline markdown form, hitting major points, adding small connections and enhancements. Feel free to flesh out logically.\n\n"
