...
def format_diary_entry():
    ...
    return f"post_help_{date_part}_{time_part}.md"
...
instructions = "Please comment, in the manner of a friendly psychologist, helping to counsel your patient on how to get through this.\n\n"
